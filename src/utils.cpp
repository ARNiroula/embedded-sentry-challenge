...
void calculate_mean(
    const float arr[MAX_ARRAY_2D_SIZE][3],
    float *mean_x,
    float *mean_y,
    float *mean_z
    ) {
    ...
    *mean_x = sum_x/MAX_ARRAY_2D_SIZE;
    *mean_y = sum_y/MAX_ARRAY_2D_SIZE;
    *mean_z = sum_z/MAX_ARRAY_2D_SIZE;
}
...
void calculate_std(
    ...
    *std_x = std::sqrt(sum_x/MAX_ARRAY_2D_SIZE);
    *std_y = std::sqrt(sum_y/MAX_ARRAY_2D_SIZE);
    *std_z = std::sqrt(sum_z/MAX_ARRAY_2D_SIZE);
}
